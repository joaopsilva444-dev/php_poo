...
echo "O Valor do desconto de $joao->nome é de $joao->descontos. <br>";
echo "O Valor do desconto de $maria->nome é de $maria->descontos. <br>";
echo "O Valor do desconto de $jose->nome é de $jose->descontos. <br>";