...
echo "O Funcionari@ $joao->nome é $joao->$tipoFuncionario e o Valor do desconto é de R$ $joao->descontos. <br>";
echo "O Funcionari@ $maria->nome é $maria->$tipoFuncionario e o Valor do desconto é de R$ $maria->descontos. <br>";
echo "O Funcionari@ $jose->nome é $jose->$tipoFuncionario e o Valor do desconto é de R$ $jose->descontos. <br>";